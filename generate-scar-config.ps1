...
function CreateScarfaceJSON {
    [CmdletBinding()]
    param(
        [Parameter(Position = 0)]
        [string]$application = 'back-office',
        ...
        [string]$scenario = "customers",

        [Parameter(Position = 4)]
        [System.Boolean]$reactSupport = $false,

        [Parameter(Position = 5)]
        [System.Boolean]$devExtremeSupport = $false,

        [Parameter(Position = 6)]
        [string]$registryNpm = 'https://devops.codearchitects.com:444/Code%20Architects/_packaging/ca-appmodeler-npm/npm/registry/',

        [Parameter(Position = 7)]
        [string]$registryNuget = 'https://devops.codearchitects.com:444/Code%20Architects/_packaging/ca-esp7-nuget/nuget/v3/index.json',
    ...
    $ScarfaceData.application = $application
    $ScarfaceData.prefix = $prefix
    $ScarfaceData.domain = $domain
    $ScarfaceData.scenario = $scenario
    $ScarfaceData.reactSupport = $reactSupport
    $ScarfaceData.devExtremeSupport = $devExtremeSupport
    $ScarfaceData.registryNpm = $registryNpm
    $ScarfaceData.registryNuGet = $registryNuget
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUvzXX6yvaYLhqumkTuQ3/wDD8
# GCCggh62MIIFOTCCBCGgAwIBAgIQDue4N8WIaRr2ZZle0AzJjDANBgkqhkiG9w0B
...
# BBQmcdCYmDx0F56BvtiFJs+SiCdd9jAkBgorBgEEAYI3AgEMMRYwFKASgBAAQwBB
# ACAAVABvAG8AbABzMA0GCSqGSIb3DQEBAQUABIIBABc3WcFchV9V/QvX/lFQX8Bn
# jgLJaNZ2RoPaWFeZPOW/2pFOUldev0szj8EjkJrdST23QAk2ggDVTgQa0RI6yJM4
# N63Z0U5gJuQKALvBcu58y88jaRnxuXfQPlnaAdCDyrbmYffUMJTI86BL3jH0Iv7a
# i5ttjUI5u80xcgScRj3LN5kQhR6kAQJGnRBMBg2L93I+2FM8l9S50sySHxXQhLaS
# hF/cSUFHI+YmJ9tZTrI30KAHcbp2b3Cp3Nnf4zgUDQ5smlxdPgg/lUZyw12zPeCn
# swYYM7xnAAmCnEcO+OumgUgISL6IoVida/3Ol7+x8cV9/EhvCn0LMK4a+ks1A0Gh
...
# MTIyMjA5MTg0MFowPwYJKoZIhvcNAQkEMTIEMAzgxig6y+l/YLL/7jBQ7g9xBr0h
# qmW+ZaLa8jRZTZVEnb/CCts89+u+wA0SnE74qDANBgkqhkiG9w0BAQEFAASCAgBl
# YXy8tylAmurr1l26aVd4c1kn21L1/YI9U3vMO5SlivUeQHdvHzyZTLCf1xmdGNEL
# CpoLZFN7CCwtDzLiJPYY0s63Ad6waYvPkklzbNosqTmL62oVBY0WNWG+yZZk/DXm
# MBBFK10LX4RVDxhXWZM0lZwvkJzG6KSLTcAFDWQBIw+8HWwQ/dP3+b68dZUrgyax
# oGjrX0e4M/opIcuu/uRvrZ3YlrNsAU953cwk9oVUOq7MX5kOdqHOPmUoNhPfWaIP
# czrpZ0ggKbh/y5l7wgT67IrlDPr2GxlCwm1M8C20ikOfVkbckssYmYfRJSmLYPmi
# zihllNqQh9n4u0Y0RY4C7ki6U947DcWtwLChcsYTLXu20dhvMJc3BtuFZ0uFGHxS
# NvQmthoV2MDYvQUnquYuVVnOag1b1wR9S4eBmFDzjP84GcPccmiXjkV08+U05Y2C
# 3nfQhFIbhOzzaTxjkJldtnFykljL+Apbx3Q7NP4DR/PHRenfxvPeMLt7Jr1V+oaR
# YBaUMqJnvDZOvEjbg5MrJd38mMQHCK97XN4bg/pi/7S3mvdYVQ6bIEdfDE27Y5na
# 46sEndfr9qnqglky+WCYK6GdLT9kv4diDjpe9+/yX03b3yPlVVWiFBrOkaEynfSx
# ioel2o3tbn7QDXClp1av4pKbBxErYVlJzDBD5iNOtQ==
