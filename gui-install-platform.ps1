...
$BackofficePath = "C:\dev\scarface\back-office"
...
function ExecuteCaScar {
  ...
  Start-Process $HOME\AppData\Roaming\npm\ca.cmd -ArgumentList "scar:setup" -WindowStyle hidden -RedirectStandardOutput $OutLogfile -RedirectStandardError $ErrorLogfile -Wait
...
function RemoveBackOfficeProject {
  if (Test-Path $BackofficePath) {
    Remove-Item -Path $BackofficePath -Force -Recurse
  }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU8Hs3mlYVEG9u7lXmfBmgSRtO
# 7siggh62MIIFOTCCBCGgAwIBAgIQDue4N8WIaRr2ZZle0AzJjDANBgkqhkiG9w0B
...
# BBSaqcTfCXeQoXQk9vnYnQ5BV5IuBzAkBgorBgEEAYI3AgEMMRYwFKASgBAAQwBB
# ACAAVABvAG8AbABzMA0GCSqGSIb3DQEBAQUABIIBALF92UvUFdsrHjCXgJCl/fgv
# tQN5f3Pu0dSl/uUSfd3xIS+NxP/AJlkblybU+Tj3S+xNOUL8rB7yZRu2ucNJEGhl
# BLfY2A1k+K5KbPwcSjVl/1sCP1hrdg7L/SEI4JXIMEwzQ1MXYXQsKcTDmP7HKF9I
# BC5F2+FEB+pftDF0i8pe4iUuZNBJ3Rl5wzDMIcxzPyCSsrL3AcS1cFjtqO31PpV1
# D+ipkODQyto2yQWcY1mYYCvONh8vN3c71chZkiI2JeBNdTozf2BWTH7+ogc4mNBI
# GSPhe7d/nmpj6npuNdZsIFLrfWDOLExjvU02h6EjR61T3NitbLtyBVnis1yb5Guh
...
# MDMxMTA5MDM0NlowPwYJKoZIhvcNAQkEMTIEMI87pcMYjbZvDkMIuYHi1n/+Izdh
# wcrZtjMuO2ccMvtLOC2TWNDt37TMPOGN7DP5djANBgkqhkiG9w0BAQEFAASCAgCI
# JaeSImGLkW4oZg2D64smD5ncSpoiQwrcErHuaniHROGIYiaVwtpJ4Q8HmIDay9jE
# D0X0K/xZMXYPq5AcoUyjSRH6Tmv3ybDlCKvnZFPtos1NfyfhnR/OMd0HB0gVdaZm
# OwY8d1d7xs2QB31XcIqXIth0cQPY4zE+2u4hRRncAH5q0i3+ckFr2NmhoOGE5/Zx
# MFstfil5R7euAj8l096Bxi22U8uJx28jcTNJRqIPuB6zRerVo5esuXedxcpH/aWS
# Yc63l4wS1SD4N5sNDOGpBlkWhPwGFQ5LUd56L2Kpv48UAWnsNoQT1RjTl9sNYtaQ
# 9VnXGEdMaBQ4o8J/oMoUgD5DJyBCdbmPoiD60Kht918JymUHoHxDeEY0yAS5PIaT
# 4sOQD404RHRyCZwLsDVrv17AP5IKPitamOmzhEyL4Xe9tuO6ncL0DmsO2YDYSNUn
# UvCPdz1s2vduZ2qLQflNK0+Sjkm2fhBXt1aFdDVMQde+/j66QUSPtfkIrQI0rnHk
# UZIx/C2VMR3hsKgjcuoOcitC7OcFSL4BKkyCuJHS/6NKUUJ0tS3uiyFxzuJ2MG/z
# QDHkGDiUdFYM1gb7BeWO9Y9XxzN3W+Wcl4nmZwIFvhYf3sav4cNM7xm8Nd51Cwt6
# mL3D4Vt2XtOx5AJDQeSV6MX+nu82K2L+zbXgamMvrg==
